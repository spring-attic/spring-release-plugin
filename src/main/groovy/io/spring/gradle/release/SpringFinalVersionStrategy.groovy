...
class SpringFinalVersionStrategy implements VersionStrategy {
    ...
    VersionStrategy delegate = Strategies.FINAL.copyWith(normalStrategy: scopes)
    ...
    ReleaseVersion infer(Project project, Grgit grgit) {
        ...
        return new ReleaseVersion(infer.version + '.RELEASE', infer.previousVersion, infer.createTag)
    }
}
